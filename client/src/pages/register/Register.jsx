            ...
            >
              <div className="register-field">
                ...
                <input
                  type="text"
                  name="username"
                  {...register("username", registerConfig.username)}
                />
              ...
              <div className="register-field">
                ...
                <input
                  type="email"
                  name="email"
                  {...register("email", registerConfig.email)}
                />
              ...
              <div className="register-field">
                ...
                <input
                  ...
                  name="password"
                  {...register("password", registerConfig.password)}
                />
                {togglePassword ? (
                  <svg
